...
export default function OceanArcticTheme({ profile, links }: Props) {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center py-12 px-4" style={{ background: '#04080e' }}>
      <style>{`html, body { background-color: #04080e !important; }`}</style>
          ...
          {profile.avatar_url ? (
            <div
              ...
              style={{
                ...
                boxShadow: '0 0 0 5px rgba(160,216,248,0.06), 0 0 0 10px rgba(160,216,248,0.03)',
              }}
            >
              <img
