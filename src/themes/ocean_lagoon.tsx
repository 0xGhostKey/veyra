    ...
    <div className="min-h-screen flex flex-col items-center py-12 px-4" style={{ background: '#02100e', overflowX: 'hidden' }}>
      <style>{`
        ...
        @keyframes oceanRipple {
          0%, 100% { box-shadow: 0 0 0 0 rgba(64,224,176,0.22), 0 0 0 7px rgba(64,224,176,0.07); }
          50%       { box-shadow: 0 0 0 10px rgba(64,224,176,0.04), 0 0 0 20px rgba(64,224,176,0); }
        }
      `}</style>
