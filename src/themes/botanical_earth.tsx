...
const LEAVES = [
  { left: '4%',  size: 26, dur: 9.0,  delay: 0,    opacity: 0.80, colorIdx: 0 },
  { left: '11%', size: 20, dur: 8.0,  delay: 1.8,  opacity: 0.70, colorIdx: 1 },
  { left: '18%', size: 30, dur: 11.5, delay: 0.4,  opacity: 0.75, colorIdx: 0 },
  { left: '25%', size: 22, dur: 8.5,  delay: 3.2,  opacity: 0.65, colorIdx: 2 },
  { left: '32%', size: 28, dur: 12.0, delay: 1.0,  opacity: 0.82, colorIdx: 1 },
  { left: '40%', size: 18, dur: 7.5,  delay: 5.5,  opacity: 0.72, colorIdx: 3 },
  { left: '48%', size: 24, dur: 10.0, delay: 0.7,  opacity: 0.78, colorIdx: 0 },
  { left: '56%', size: 32, dur: 9.0,  delay: 4.1,  opacity: 0.68, colorIdx: 1 },
  { left: '64%', size: 20, dur: 13.0, delay: 2.3,  opacity: 0.75, colorIdx: 2 },
  { left: '72%', size: 26, dur: 8.2,  delay: 0.5,  opacity: 0.80, colorIdx: 3 },
  { left: '80%', size: 22, dur: 10.5, delay: 6.8,  opacity: 0.70, colorIdx: 0 },
  { left: '88%', size: 18, dur: 11.5, delay: 3.6,  opacity: 0.76, colorIdx: 1 },
]
