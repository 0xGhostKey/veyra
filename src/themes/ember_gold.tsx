...
const SPARKS = [
  ...
  { left: '39%', size: 6,  dur: 4.1, delay: 4.0,  color: '#ffd060' },
  { left: '43%', size: 7,  dur: 3.7, delay: 2.5,  color: '#ffaa00' },
  { left: '47%', size: 5,  dur: 4.9, delay: 0.9,  color: '#ffd060' },
  { left: '51%', size: 4,  dur: 3.4, delay: 3.8,  color: '#ffaa00' },
  { left: '55%', size: 9,  dur: 5.1, delay: 1.1,  color: '#ffd060' },
  { left: '59%', size: 6,  dur: 4.3, delay: 0.3,  color: '#ffaa00' },
  ...
  { left: '75%', size: 5,  dur: 3.8, delay: 3.1,  color: '#ffaa00' },
  { left: '79%', size: 7,  dur: 4.5, delay: 1.4,  color: '#ffd060' },
  { left: '83%', size: 6,  dur: 3.2, delay: 4.7,  color: '#ffaa00' },
  ...
  { left: '5%',  size: 6,  dur: 4.8, delay: 5.1,  color: '#ffd060' },
  { left: '13%', size: 4,  dur: 3.3, delay: 7.3,  color: '#ffaa00' },
  { left: '29%', size: 7,  dur: 5.5, delay: 4.3,  color: '#ffd060' },
  { left: '41%', size: 5,  dur: 4.0, delay: 6.9,  color: '#ffaa00' },
  { left: '53%', size: 9,  dur: 3.9, delay: 8.1,  color: '#ffd060' },
  { left: '65%', size: 6,  dur: 4.6, delay: 3.6,  color: '#ffaa00' },
  { left: '77%', size: 7,  dur: 3.4, delay: 7.5,  color: '#ffd060' },
  { left: '93%', size: 4,  dur: 5.2, delay: 5.8,  color: '#ffaa00' },
]
