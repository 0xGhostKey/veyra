...
const LEAVES = [
  { left: '5%',  size: 14, dur: 10.0, delay: 0,   opacity: 0.30 },
  { left: '12%', size: 18, dur:  8.5, delay: 1.8,  opacity: 0.25 },
  { left: '19%', size: 11, dur: 12.5, delay: 0.4,  opacity: 0.40 },
  { left: '26%', size: 20, dur:  9.0, delay: 3.2,  opacity: 0.28 },
  { left: '33%', size: 13, dur: 13.5, delay: 1.0,  opacity: 0.35 },
  { left: '41%', size: 16, dur:  8.0, delay: 5.5,  opacity: 0.25 },
  { left: '49%', size: 10, dur: 11.0, delay: 0.7,  opacity: 0.45 },
  { left: '57%', size: 19, dur:  9.5, delay: 4.1,  opacity: 0.28 },
  { left: '64%', size: 12, dur: 14.0, delay: 2.3,  opacity: 0.32 },
  { left: '72%', size: 17, dur:  8.8, delay: 0.5,  opacity: 0.38 },
  { left: '80%', size: 15, dur: 10.5, delay: 6.8,  opacity: 0.26 },
  { left: '88%', size: 11, dur: 12.0, delay: 3.6,  opacity: 0.34 },
]
  ...
  return (
    <>
      <style>{`
        ...
        @keyframes ivoryGlow {
          0%, 100% { box-shadow: 0 0 16px rgba(90,128,64,0.25); }
          50%       { box-shadow: 0 0 28px rgba(122,184,96,0.45), 0 0 50px rgba(90,128,64,0.15); }
        }
      `}</style>
        ...
        {LEAVES.map((l, i) => (
          <div
            ...
            style={{
              ...
              top: '-20px',
              left: l.left,
              animation: `leafFallIvory ${l.dur}s ease-in ${l.delay}s infinite`,
      ...
      <div className="min-h-screen flex flex-col items-center py-12 px-4" style={{ background: '#f5f0e8', overflowX: 'hidden' }}>
        <div className="w-full max-w-md" style={{ position: 'relative', zIndex: 1 }}>
          {/* Top divider */}
          <div className="h-px mb-8" style={{ background: 'linear-gradient(90deg, transparent, #5a8040, transparent)' }} />
          ...
          <div className="flex flex-col items-center mb-10">
            <div className="relative mb-4" style={{ width: 96, height: 96 }}>
              {profile.avatar_url ? (
                <div
                  ...
                  style={{
                    background: 'linear-gradient(135deg, #7ab860, #3a6020)',
                    animation: 'ivoryGlow 2.8s ease-in-out infinite',
                  }}
                >
                  <img
            ...
            <div className="w-12 h-px mb-3" style={{ background: 'linear-gradient(90deg, transparent, #5a8040, transparent)' }} />
            {profile.bio && (
          ...
          <div className="h-px mt-10 mb-6" style={{ background: 'linear-gradient(90deg, transparent, #5a8040, transparent)' }} />
