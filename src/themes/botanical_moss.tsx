...
const LEAVES = [
  { left: '2%',  size: 27, dur: 9.0,  delay: 0,    opacity: 0.70 },
  { left: '8%',  size: 23, dur: 7.5,  delay: 2.2,  opacity: 0.62 },
  { left: '14%', size: 33, dur: 11.0, delay: 0.7,  opacity: 0.75 },
  { left: '20%', size: 25, dur: 8.8,  delay: 4.1,  opacity: 0.58 },
  { left: '27%', size: 29, dur: 10.5, delay: 1.4,  opacity: 0.68 },
  { left: '33%', size: 21, dur: 9.2,  delay: 6.3,  opacity: 0.60 },
  { left: '40%', size: 36, dur: 12.0, delay: 0.3,  opacity: 0.72 },
  { left: '47%', size: 26, dur: 8.0,  delay: 3.8,  opacity: 0.65 },
  { left: '54%', size: 20, dur: 11.5, delay: 5.5,  opacity: 0.55 },
  { left: '61%', size: 31, dur: 9.8,  delay: 1.0,  opacity: 0.70 },
  { left: '68%', size: 23, dur: 7.8,  delay: 7.2,  opacity: 0.62 },
  { left: '75%', size: 29, dur: 10.2, delay: 2.6,  opacity: 0.68 },
  { left: '82%', size: 21, dur: 9.5,  delay: 4.9,  opacity: 0.58 },
  { left: '88%', size: 33, dur: 11.8, delay: 0.8,  opacity: 0.72 },
  { left: '93%', size: 25, dur: 8.5,  delay: 6.1,  opacity: 0.60 },
  { left: '97%', size: 27, dur: 10.0, delay: 3.3,  opacity: 0.66 },
]
    ...
    <>
      <style>{`
        ...
        @keyframes avatarGlow {
          ...
          50%       { box-shadow: 0 0 48px rgba(160,232,112,0.82), 0 0 75px rgba(126,200,80,0.28); }
        }
      `}</style>
      ...
      <div style={{
        ...
        background: 'linear-gradient(to bottom, #070b04 0%, transparent 100%)',
        pointerEvents: 'none', zIndex: 0,
      }} />
      {/* Bottom atmospheric fade */}
      <div style={{
        position: 'fixed', bottom: 0, left: 0, right: 0, height: '18%',
        background: 'linear-gradient(to top, #070b04 0%, transparent 100%)',
        pointerEvents: 'none', zIndex: 0,
      }} />
        ...
        {LEAVES.map((l, i) => (
          <div
            ...
            style={{
              ...
              top: '-50px',
              left: l.left,
              filter: `drop-shadow(0 0 4px ${C}55)`,
      ...
      <div className="min-h-screen flex flex-col items-center py-12 px-4" style={{ background: 'radial-gradient(ellipse 120% 70% at 50% 30%, #0e1c09 0%, #080c05 55%, #040703 100%)', overflowX: 'hidden' }}>
        <div className="w-full max-w-md" style={{ position: 'relative', zIndex: 2 }}>
          ...
          <div className="flex justify-center mb-6">
            <svg width="320" height="72" viewBox="0 0 320 72">
              ...
              <g transform="translate(55,36)">
                ...
                <g transform="translate(-5,-18) rotate(-27)"><BranchLeaf color={C} opacity={0.44} /></g>
                <line x1="0" y1="0" x2="5" y2="-10" stroke={C} strokeWidth="0.7" strokeOpacity="0.32" />
                <g transform="translate(5,-18) rotate(27)"><BranchLeaf color={C} opacity={0.38} /></g>
              </g>
              <g transform="translate(105,36)">
                <line x1="0" y1="0" x2="-5" y2="10" stroke={C} strokeWidth="0.7" strokeOpacity="0.28" />
                <g transform="translate(-5,18) rotate(-153)"><BranchLeaf color={C} opacity={0.32} /></g>
                <line x1="0" y1="0" x2="5" y2="10" stroke={C} strokeWidth="0.7" strokeOpacity="0.28" />
                <g transform="translate(5,18) rotate(153)"><BranchLeaf color={C} opacity={0.28} /></g>
              </g>
              <g transform="translate(160,36)">
                ...
                <g transform="translate(0,-18) rotate(0)"><BranchLeaf color={C} opacity={0.40} /></g>
                <line x1="0" y1="0" x2="-6" y2="-8" stroke={C} strokeWidth="0.6" strokeOpacity="0.24" />
                <g transform="translate(-6,-16) rotate(-37)"><BranchLeaf color={C} opacity={0.30} /></g>
                <line x1="0" y1="0" x2="6" y2="-8" stroke={C} strokeWidth="0.6" strokeOpacity="0.24" />
                <g transform="translate(6,-16) rotate(37)"><BranchLeaf color={C} opacity={0.30} /></g>
              </g>
            ...
            <div className="relative mb-4" style={{ width: 96, height: 96 }}>
              {profile.avatar_url ? (
                <div
                  ...
                  style={{ background: 'linear-gradient(135deg, #a0e870, #3a8020)', animation: 'avatarGlow 2.8s ease-in-out infinite' }}
                >
                ...
                <div
                  ...
                  style={{ background: '#0d1408', border: '1px solid rgba(126,200,80,0.4)', animation: 'avatarGlow 2.8s ease-in-out infinite' }}
                >
          ...
          <div className="flex justify-center mt-10 mb-6">
            <svg width="320" height="72" viewBox="0 0 320 72">
              ...
              <g transform="translate(55,36)">
                <line x1="0" y1="0" x2="-5" y2="10" stroke={C} strokeWidth="0.7" strokeOpacity="0.32" />
                <g transform="translate(-5,18) rotate(-153)"><BranchLeaf color={C} opacity={0.44} /></g>
                <line x1="0" y1="0" x2="5" y2="10" stroke={C} strokeWidth="0.7" strokeOpacity="0.32" />
                <g transform="translate(5,18) rotate(153)"><BranchLeaf color={C} opacity={0.38} /></g>
              </g>
              <g transform="translate(105,36)">
                <line x1="0" y1="0" x2="-5" y2="-10" stroke={C} strokeWidth="0.7" strokeOpacity="0.28" />
                <g transform="translate(-5,-18) rotate(-27)"><BranchLeaf color={C} opacity={0.32} /></g>
                <line x1="0" y1="0" x2="5" y2="-10" stroke={C} strokeWidth="0.7" strokeOpacity="0.28" />
                <g transform="translate(5,-18) rotate(27)"><BranchLeaf color={C} opacity={0.28} /></g>
              </g>
              <g transform="translate(160,36)">
                <circle cx="0" cy="0" r="2.5" fill={C} fillOpacity="0.52" />
                <line x1="0" y1="0" x2="0" y2="10" stroke={C} strokeWidth="0.7" strokeOpacity="0.30" />
                <g transform="translate(0,18) rotate(180)"><BranchLeaf color={C} opacity={0.40} /></g>
                <line x1="0" y1="0" x2="-6" y2="8" stroke={C} strokeWidth="0.6" strokeOpacity="0.24" />
                <g transform="translate(-6,16) rotate(-143)"><BranchLeaf color={C} opacity={0.30} /></g>
                <line x1="0" y1="0" x2="6" y2="8" stroke={C} strokeWidth="0.6" strokeOpacity="0.24" />
                <g transform="translate(6,16) rotate(143)"><BranchLeaf color={C} opacity={0.30} /></g>
              </g>
              <g transform="translate(215,36)">
