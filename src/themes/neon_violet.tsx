...
export default function NeonVioletTheme({ profile, links }: Props) {
  ...
  return (
    <>
      <style>{`html, body { background-color: #050510 !important; }`}</style>
      <div className="min-h-screen bg-[#050510] flex flex-col items-center py-12 px-4">
            ...
            {profile.avatar_url ? (
              <div
                ...
                style={{
                  ...
                  boxShadow: '0 0 20px rgba(191, 0, 255, 0.5), 0 0 40px rgba(57, 255, 20, 0.3)',
                }}
              >
                <img
              ...
              <div
                ...
                style={{
                  ...
                  boxShadow: '0 0 20px rgba(191, 0, 255, 0.5), inset 0 0 20px rgba(191, 0, 255, 0.1)',
                }}
              >
                <span
